...
import {StyleSheet,Button, View,Image, Text,Touchable, Platform} from 'react-native';
  ...
  return (
    <View style={style.container} >
      ...
      <TextInput
        ...
        style={style.entryStyle} placeholder="User name"/>
      <Text style={style.labelStyle}>Password</Text>
      <TextInput 
      onChangeText={(text)=>this.setState({password:text})}
      secureTextEntry={true} style={style.entryStyle} placeholder="Password"/>
      {/* <Button
        title="Login"
